            ...
            <div class="row">
             <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Título" name="tituloForm" value="<?php print $titulo; ?>">
                </div>

                <div class="form-group">
                  <label for="exampleInputEmail1">Texto</label>
                  <textarea class="form-control" rows="7" cols="50" placeholder="Descrição" name="textForm"><?php print $texto; ?></textarea>
                </div>
