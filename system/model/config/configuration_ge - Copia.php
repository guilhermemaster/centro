...
*/
		...
		$conexao = mysql_connect("mysql.weblink.com.br", "u179029833_root", "pryItv75gie") or die ("<script>alert(\"Erro ao Conectar ao Banco de Dados!\");</script>");
		$db = mysql_select_db("u179029833_sys2") or die ("<script>alert(\"Erro ao selecionar o Banco de Dados!\");</script>"); 
