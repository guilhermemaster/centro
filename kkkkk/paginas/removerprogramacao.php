...
<meta charset="utf-8" />
<title></title>
<link rel="stylesheet" href="../style_paginas/delprogramacao.css" type="text/css" />
</head>
<body>
...
$sql="SELECT * FROM Programacao ORDER BY idProgramacao ";
...
print "<a href=\"removerprogramacao_validar.php?remover=".$linha['idProgramacao']."\" >Deletar</a>";
